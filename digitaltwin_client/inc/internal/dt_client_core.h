...
MOCKABLE_FUNCTION(, DIGITALTWIN_CLIENT_RESULT, DT_ClientCoreRegisterInterfacesAsync, DT_CLIENT_CORE_HANDLE, dtClientCoreHandle, DIGITALTWIN_INTERFACE_CLIENT_HANDLE*, dtInterfaces , unsigned int, numDTInterfaces);
