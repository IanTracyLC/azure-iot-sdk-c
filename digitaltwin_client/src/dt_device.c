...
DIGITALTWIN_CLIENT_RESULT DigitalTwin_DeviceClient_RegisterInterfacesAsync(DIGITALTWIN_DEVICE_CLIENT_HANDLE dtDeviceClientHandle, DIGITALTWIN_INTERFACE_CLIENT_HANDLE* dtInterfaces, unsigned int numDTInterfaces)
{
