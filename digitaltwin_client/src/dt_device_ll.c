...
DIGITALTWIN_CLIENT_RESULT DigitalTwin_DeviceClient_LL_RegisterInterfacesAsync(DIGITALTWIN_DEVICE_CLIENT_LL_HANDLE dtDeviceClientHandle,DIGITALTWIN_INTERFACE_CLIENT_HANDLE* dtInterfaces, unsigned int numDTInterfaces)
{
    return DT_ClientCoreRegisterInterfacesAsync((DT_CLIENT_CORE_HANDLE)dtDeviceClientHandle, dtInterfaces, numDTInterfaces);
}
